...
# Add Category Item
categoryItem1 = CategoryItem(name="Freeride Snowboard", description="This snowboard is appropriate for children ages 5 to 15. Weight limit is up to 95 lbs", category_id=5, user_id=1)
